...
//======================================================================//     
// Fun��o padr�o para conex�o com BD...
//======================================================================//     
     function fConexaoComBD() {
        $vOK = "S";

// 07/02/2018 ---> Verificar se tem a extens�o para acesso ao MYSQL...        
        $vDados = "";

        if (!extension_loaded('mysqli')) {
           $vOK = "N";  
           $vAux    = "Extens�o mysqli n�o carregada (verifique php.ini) ";          
        ...
        if (!function_exists('mysqli_init')) {
           $vOK = "N";  
           $vAux    = "Fun��o mysqli_init n�o encontrada ";          
           $vDados .= "[[VALIDACAO]]false[[/VALIDACAO]]"; 
           $vDados .= "[[MSGCONN]]" . $vAux . "[[/MSGCONN]]";
        }
        ...
        if ($vOK === "S") {
           ...
           if ($vConn->connect_error) {
              $vOK = "N";  
              $vAux    = " N�o conseguiu conex�o com MYSQL !!! ";          
              $vDados .= "[[VALIDACAO]]false[[/VALIDACAO]]"; 
              $vDados .= "[[MSGCONN]]" . $vAux . "[[/MSGCONN]]";
            }
        }   
        ...
        if ($vOK === "S") {
           ...
           if($vDB === FALSE) {
              $this->mMsgConn = "N�o conseguiu acessar o database: " . mysqli_error();
              $vOK     = "N";
              $vDados  = "[[VALIDACAO]]false[[/VALIDACAO]]"; 
              $vDados .= "[[MSGCONN]]" . $this->mMsgConn . "[[/MSGCONN]]";
           }
           else {
//====> 07/05/2014 ====>Para acentuar corretamente... Ao fazer conex�o especificar charset...               
              ...
              $vAux    = "OK !!! Conseguiu conex�o com o MYSQL e o database ";          
...
//======================================================================//     
// Op��o 01 de fun��o para pegar dados montando SQL...
//======================================================================//     
...
//---> Se OK = "S", ent�o formatar dados com MeuXML...
        if ($vOK === "S") {
            $vDados .= "[[VALIDACAO]]true[[/VALIDACAO]]";             
            $vSql = " select ";
