...
function f001_UsuarioExiste_A(aProximaPagina) {
   alert("ZZZ = " + gDados);
    ...
    var vTotReg = -1;
    var vNickUsr = fg_ProcessaCampoDeTexto('txtNickUsr');
    var vSenhaDigitada = fg_ProcessaCampoDeTexto('txtSenha');
    var vSenhaBanco = "";
...
if (vTotReg <= 0) {
    ...
    vMsg = "Usuário " + 
           "<b><font color='#FF0000'>" + vNickUsr + "</font></b>" + 
           " não cadastrado";
    ...
    vSenhaBanco = fg_PegaValorDoMeuXML("SENHAUSR", gDados);
    alert ("AAA = " + vSenhaBanco);

    if (vSenhaDigitada !== vSenhaBanco) {

        vMsg = "Senha incorreta para o usuário " + 
               "<b><font color='#FF0000'>" + vNickUsr + "</font></b>";
